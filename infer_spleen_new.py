...
module_dir = './module/model_best/FINAL_spleen_net_2_1100-0.021-0.092.pth'
...
workbook = xw.Workbook('./SPLEEN_INFER.xlsx')
...
#    seg_array = sitk.GetArrayFromImage(seg)
    ...
    sitk.WriteImage(pred_seg, os.path.join(organ_pred_dir, file.replace('img', 'spleen')))
    del pred_seg
